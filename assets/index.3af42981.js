...
`,be=m.article.attrs((()=>({className:"fields"})))``,Ee={email:null,card_number:null,card_expire:null,cvv:null},ye=({onSuccess:e,loading:t=!1,submitText:r="Submit"})=>{const{models:a,register:n,updateModel:o}=v({defaultState:Ee}),{state:l,setData:s}=b({initialData:Ee,schema:E.object({email:E.string().email({tlds:{allow:!1}}).required().messages({"string.empty":"Required","string.email":"Must be a valid email","any.required":"Required"}),card_number:E.string().custom(((e,t)=>{if(e){if(!y.exports.validateCardNumber(e))return t.error("string.cardNumber");if(!["mastercard","visa"].includes(y.exports.parseCardType(e)))return t.error("string.cardType")}return e})).required().messages({"string.empty":"Required","string.cardNumber":"Must be a valid card","string.cardType":"Must be Mastercard or Visa type","any.required":"Required"}),card_expire:E.string().custom(((e,t)=>e&&!y.exports.validateCardExpiry(...e.split("/"))?t.error("string.card_expire"):e)).required().messages({"string.empty":"Required","string.card_expire":"Invalid","any.required":"Required"}),cvv:E.string().length(3).custom(((e,t)=>e&&!y.exports.validateCardCVC(e)?t.error("string.cvv"):e)).required().messages({"string.empty":"Required","string.length":"Maximum 3 digits","string.cvv":"Invalid code","any.required":"Required"})})}),d=u.exports.useCallback((e=>l.$errors[e].map((e=>e.$message)).join(",")),[l.$errors]),p={cardNumber:e=>{const t=y.exports.formatCardNumber(e.target.value);o("card_number",t)},cardExpire:e=>{const t=y.exports.formatCardExpiry(e.target.value);o("card_expire",t)}};return u.exports.useEffect((()=>{s(a)}),[a]),f.createElement(se,null,f.createElement(de,{onSubmit:t=>{t.preventDefault(),e(l.$data)}},f.createElement(be,null,f.createElement(me,null,f.createElement(ge,{error:!!d("email")},"Email"),f.createElement(fe,c(i({},n.input({name:"email"})),{type:"email",placeholder:"you@company.com",autoComplete:"current-email"}))),d("email")&&f.createElement(xe,null,d("email"))),f.createElement(ue,null,f.createElement(be,null,f.createElement(me,null,f.createElement(ge,{error:!!d("card_number")},"Card information"),f.createElement(fe,c(i({},n.input({name:"card_number",onChange:p.cardNumber})),{type:"text",placeholder:"1234 1234 1234 1234"}))),d("card_number")&&f.createElement(xe,null,d("card_number"))),f.createElement(pe,null,f.createElement(be,null,f.createElement(fe,c(i({},n.input({name:"card_expire",onChange:p.cardExpire})),{type:"text",placeholder:"MM / YY"})),d("card_expire")&&f.createElement(xe,null,d("card_expire"))),f.createElement(be,null,f.createElement(fe,c(i({},n.input({name:"cvv"})),{type:"text",placeholder:"123"})),d("cvv")&&f.createElement(xe,null,d("cvv"))))),f.createElement(he,null,f.createElement(ve,{disabled:l.$auto_invalid||t},r))))},we=m.section`
    width: 420px;
    max-width: 100%;
    padding: 40px 20px;
`,Ce=m.section`
