var e=Object.defineProperty,t=Object.defineProperties,r=Object.getOwnPropertyDescriptors,a=Object.getOwnPropertySymbols,n=Object.prototype.hasOwnProperty,o=Object.prototype.propertyIsEnumerable,l=(t,r,a)=>r in t?e(t,r,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[r]=a,i=(e,t)=>{for(var r in t||(t={}))n.call(t,r)&&l(e,r,t[r]);if(a)for(var r of a(t))o.call(t,r)&&l(e,r,t[r]);return e},s=(e,a)=>t(e,r(a));import{u as c,a as d,r as u,b as m,q as p,$ as g,R as f,A as x,c as h,d as b,e as v,J as E,f as y,t as w,S as _,g as k,h as q,i as C,T as $,P as L}from"./vendor.9e6d6e86.js";const R=`${{}.VITE_APP_TITLE}`,M=(e={})=>{const{title:t,suffix:r=R,addSuffix:a=!0,returnAppTitle:n=!0}=e;return void 0===t&&n?R:a?`${t} - ${r}`:t||""},S=({name:e,prefix:t="ActivePage"})=>{const r=document.documentElement,a=`${t}--${e}`;u.exports.useEffect((()=>(r.classList.add(a),()=>{r.classList.remove(a)})),[])},{CancelToken:P,isCancel:z,create:A}=m,T=({data:e})=>e,j=e=>{const t=(({baseURL:e,initialState:t})=>{const r=P.source(),a=r.token,n=A({baseURL:e,cancelToken:a}),[o,l]=u.exports.useState((()=>t));return u.exports.useEffect((()=>()=>{r.cancel()}),[]),{Request:n,state:o,apiSource:r,setState:l,setAuth:(e,t="Bearer")=>{n.defaults.headers.common.Authorization=e?`${t} ${e}`:null},successResolver:T,isCancel:z}})({baseURL:`${{}.VITE_API_1}`,initialState:e}),{Request:r,setAuth:l}=t,s=((e,t)=>{var r={};for(var l in e)n.call(e,l)&&t.indexOf(l)<0&&(r[l]=e[l]);if(null!=e&&a)for(var l of a(e))t.indexOf(l)<0&&o.call(e,l)&&(r[l]=e[l]);return r})(t,["Request","setAuth"]);return i({Request:r},s)},V=p.section`
    width: 100%;
    display: flex;
    flex: 1;
...
`,H=({children:e,BlockName:t="LayoutCenter"})=>((({name:e,prefix:t="ActiveLayout"})=>{const r=document.documentElement,a=`${t}--${e}`;u.exports.useEffect((()=>(r.classList.add(a),()=>{r.classList.remove(a)})),[])})({name:t}),f.createElement(V,null,f.createElement(O,null),f.createElement(B,null,e))),F=(e=!0)=>x`
    ${e&&x`
        display: block;
    `}
...
`,Le=p.div`
    ...
    font-weight: 500;
    color: var(--product_description);
`,Re=[{path:"/",key:"products",title:"Products",component:({BlockName:e="PageProducts"})=>{S({name:e});const[,t]=d(),r=h(),{state:a,fetch:n}=(()=>{const e={loading:!1,data:[],error:null},{Request:t,state:r,setState:a,successResolver:n,isCancel:o}=j(e);return{state:r,fetch:u.exports.useCallback((async(r={})=>{a((t=>s(i({},t),{loading:!0,error:e.error})));const l=t({method:"get",url:"/products",params:r}).then(n).then(((t=e.data)=>{a((e=>s(i({},e),{data:t})))})).catch((e=>{if(o(e))return e;a((t=>{var r,a;return s(i({},t),{error:(null==(a=null==(r=null==e?void 0:e.response)?void 0:r.data)?void 0:a.message)||e.message})}))}));o(await l)||a((e=>s(i({},e),{loading:!1})))}),[a])}})(),o=u.exports.useMemo((()=>a.data.map((e=>s(i({},e),{qty:0})))),[a.data]),[l,c]=u.exports.useState([]),m=u.exports.useMemo((()=>l.reduce(((e,{qty:t})=>e+t),0)),[l]),p=u.exports.useMemo((()=>m<=0),[m]),g=u.exports.useMemo((()=>p||a.loading),[p,a.loading]),x=()=>{t("/checkout")};return u.exports.useEffect((()=>{n()}),[n]),u.exports.useEffect((()=>{c(o)}),[o,c]),u.exports.useEffect((()=>{const e=l.filter((({qty:e})=>e>0));r({type:"UPDATE_CART",value:e})}),[l,r]),f.createElement(H,null,f.createElement(Z,null,f.createElement(D,null,"Products"),f.createElement(N,null,l.map((({id:e,name:t,price:r,qty:a})=>f.createElement(U,{key:e},f.createElement(Y,null),f.createElement(J,null,t),f.createElement(G,null,r.toLocaleString()," THB"),f.createElement(Q,null,f.createElement(X,{disabled:a<=0,onClick:()=>(e=>{c((t=>t.map((t=>{if(e!==t.id)return t;const r=t.qty>0?t.qty-1:0;return s(i({},t),{qty:r})}))))})(e)},f.createElement(oe,null)),f.createElement(W,null,a),f.createElement(X,{onClick:()=>(e=>{c((t=>t.map((t=>{if(e!==t.id)return t;const r=t.qty+1;return s(i({},t),{qty:r})}))))})(e)},f.createElement(ne,null))),f.createElement(K,null,"quantity"))))),f.createElement(ee,null,f.createElement(ae,{disabled:p,onClick:x},f.createElement(le,null),f.createElement(re,{hidden:p},m)),f.createElement(te,{disabled:g,onClick:x},"Checkout"))))}},{path:"/checkout",key:"checkout",title:"Checkout",component:({BlockName:e="PageCheckout"})=>{S({name:e});const[,t]=d(),{state:{loading:r},post:a}=(()=>{const e={loading:!1,data:[],error:null},{Request:t,state:r,setState:a,successResolver:n,isCancel:o}=j(e);return{state:r,post:u.exports.useCallback((async r=>{a((t=>s(i({},t),{loading:!0,error:e.error})));const l=t({method:"post",url:"/pay",data:r}).then(n).then(((t=e.data)=>{a((e=>s(i({},e),{data:t})))})).catch((e=>{if(o(e))return e;a((t=>{var r,a;return s(i({},t),{error:(null==(a=null==(r=null==e?void 0:e.response)?void 0:r.data)?void 0:a.message)||e.message})}))}));o(await l)||a((e=>s(i({},e),{loading:!1})))}),[a])}})(),n=y((e=>e.cart)),o=u.exports.useMemo((()=>n.filter((e=>e.qty>0)).reduce(((e,{qty:t,price:r})=>e+t*r),0)),[n]);return u.exports.useEffect((()=>{n.length||(t("/"),w.error("Empty products. Please add some."))}),[n]),f.createElement(H,null,f.createElement(Ee,null,f.createElement(D,null,"Checkout"),f.createElement(ye,null,n.map((({id:e,name:t,price:r,qty:a})=>f.createElement(we,{key:e},f.createElement(_e,null),f.createElement(ke,null,f.createElement(qe,null,t),f.createElement(Ce,null,r.toLocaleString()," THB")),f.createElement(ke,null,f.createElement($e,null,(r*a).toLocaleString()," THB"),f.createElement(Le,null,"qty: ",a)))))),f.createElement(ve,{onSuccess:e=>{w.promise(a({paymentInfo:{cardInfo:{cardNo:`${e.card_number}`,cardCVV:`${e.cvv}`,cardExpiryDate:`${e.card_expire}`},email:`${e.email}`},products:n.map((e=>({id:e.id,quantity:e.qty})))}),{loading:"Paying...",success:"Success",error:"Something went wrong"})},submitText:`Pay ${o.toLocaleString()} THB`,loading:r})))}},{key:"404",title:"Page not found",component:()=>f.createElement(f.Fragment,null,"404, Not Found!")}],Me=()=>((e=>{const{matcher:t}=c(),[r]=d();u.exports.useEffect((()=>{let a=e.find((({path:e})=>t(e,r)[0]));a||(a=e.find((({path:e})=>null==e))),a&&(document.title=M({title:a.title}))}),[r])})(Re),f.createElement(_,null,Re.map((({component:e,path:t,key:r})=>f.createElement(k,{key:t||r,path:t,component:e}))))),Se=q(((e,t)=>{const{type:r,value:a}=t;switch(r){case"UPDATE_CART":return s(i({},e),{cart:a});default:return e}}),{cart:[]});document.title=M(),C.exports.render(f.createElement(u.exports.StrictMode,null,f.createElement($,{position:"top-center",reverseOrder:!0}),f.createElement(L,{store:Se},f.createElement(Me,null))),document.getElementById("root"));
